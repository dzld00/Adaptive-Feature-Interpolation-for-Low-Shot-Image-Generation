...
def setup_training_loop_kwargs(
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss_interp.StyleGAN2Loss', r1_gamma=spec.gamma)
    ...
    if cfg == 'cifar':
        ...
        args.D_kwargs.architecture = 'orig' #'resnet' #orig # disable residual skip connections
